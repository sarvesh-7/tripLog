        ...
        <>
            <header className='w-[90%] max-w-6xl flex flex-wrap justify-center gap-10 mt-15 mx-auto'>
                ...
                <div className='flex flex-col gap-2 justify-center'>
                    <h1 className='text-[3.5rem] uppercase'>{tripData.title}</h1>
                    ...
                    <p className='text-[1.5rem]'>{tripData.summary}</p>
                </div>
            </header>
            <main
                className='w-[60%] max-w-5xl mt-10 mx-auto bg-[#6e6464] p-8 rounded-md text-[#13120f] text-[1.25rem]'
